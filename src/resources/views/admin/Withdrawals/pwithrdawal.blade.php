                            ...
                            @if ($method->defaultpay == 'yes')
                                @if ($withdrawal->payment_mode == 'Bitcoin')
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->btc_address }}" readonly>
                                    </div>
                                @elseif($withdrawal->payment_mode == 'Ethereum')
                                    <div class="mb-3 form-group">
                                        <h5 class="">ETH Address</h5>
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->eth_address }}" readonly>
                                    </div>
                                @elseif($withdrawal->payment_mode == 'Litecoin')
                                    <div class="mb-3 form-group">
                                        <h5 class="">LTC Address</h5>
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->ltc_address }}" readonly>
                                    </div>
                                @elseif ($withdrawal->payment_mode == 'USDT')
                                    <h5 class="">USDT Address</h5>
                                    <input type="text" class="form-control readonly  "
                                        value="{{ optional($withdrawal->duser)->usdt_address }}" readonly>
                                ...
                                @elseif($withdrawal->payment_mode == 'Bank Transfer')
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->bank_name }}" readonly>
                                    </div>
                                    <div class="mb-3 form-group">
                                        <h5 class="">Account Name</h5>
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->account_name }}" readonly>
                                    </div>
                                    <div class="mb-3 form-group">
                                        <h5 class="">Account Number</h5>
                                        <input type="text" class="form-control readonly  "
                                            value="{{ optional($withdrawal->duser)->account_number }}" readonly>
                                    </div>
                                    @if (!empty($withdrawal->duser->swift_code))
                                        <div class="mb-3 form-group">
                                            <h5 class="">Swift Code</h5>
                                            <input type="text" class="form-control readonly  "
                                                value="{{ optional($withdrawal->duser)->swift_code }}" readonly>
                                        </div>
                                    @endif
                                @endif
                            @else
